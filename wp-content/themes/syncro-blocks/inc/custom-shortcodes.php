...
function syncro_blocks_table_header_shortcode($atts = array(), $content = null)
{
...
add_shortcode('table_header', 'syncro_blocks_table_header_shortcode');



//Creates shortcodes for [highlight] and [/highlight]
function syncro_blocks_wysiwyg_highlight($atts = array(), $content = null)
{
...
add_shortcode('highlight', 'syncro_blocks_wysiwyg_highlight');

//Creates shortcodes for [youtubeshort] and [/youtubeshort]
function syncro_blocks_vertical_video_embed($atts, $content = null)
{
  $content = do_shortcode($content);
  return '<div class="verticalvideo">' . $content . '</div>';
}
add_shortcode('youtubeshort', 'syncro_blocks_vertical_video_embed');


//Creates shortcodes for [podcastbadges] 
function syncro_blocks_podcast_links($atts)
{
...
add_shortcode('podcastlinks', 'syncro_blocks_podcast_links');


//Creates shortcodes for [custombullet] and [/custombullet]
function syncro_blocks_custom_bullet($atts = array(), $content = null)
{
  // set up default parameters
  extract(shortcode_atts(array(
...
add_shortcode('custombullet', 'syncro_blocks_custom_bullet');
