...
$sticky_header_classes  = 'cdc-mobile-menu-template-part__sticky-header';

$menu_classes  = 'cdc-mobile-menu-template-part__menu-container';
...
>
	...
	<div 
		class="<?php echo $sticky_header_classes; ?>"
		tabindex="-1"
	...
	>
		<div class="wp-block-group is-content-justification-space-between is-nowrap is-layout-flex wp-block-group-is-layout-flex" style="margin-top:14px;margin-bottom:14px">
			<div style="padding-top:7px;padding-bottom:7px;" class="wp-block-site-logo">
				<?php echo mobile_menu_template_part_get_sized_logo( array( 'width' => 118, 'height' => 20 ) ); ?>
			</div>
